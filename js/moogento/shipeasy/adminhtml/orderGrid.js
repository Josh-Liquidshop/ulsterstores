...
//                $selectElem.hide();
    ...
    $('#anchor-content').on('click', '.customer_weight_list .edit-icon', function (e) {
        var parent_td = $(this).closest('.customer_weight_list');
        parent_td.removeClass('non-edit');
        parent_td.addClass('for-edit');
    ...
    $('#anchor-content').on('click', '.customer_weight_list .inputs_for_admin_weight .cancel_for_admin_weight', function (e) {
        var parent_td = $(this).closest('.customer_weight_list');
        var select_cust = parent_td.find('#select_customer');
        select_cust.val(select_cust.data('value'));
        parent_td.removeClass('for-edit');
    ...
    $('#anchor-content').on('click', '.customer_weight_list .inputs_for_admin_weight .submit_for_admin_weight', function (e) {
        var parent_td = $(this).closest('.customer_weight_list');
        var input_for_weight = parent_td.find('.text_for_admin_weight');
        showSpinner(parent_td);

        changeRestriction(parent_td);

        var url_data = input_for_weight.data('changeurl');
        var order_id = input_for_weight.data('orderid');
        var weight = input_for_weight.val();
        $.ajax({
            type: 'POST',
            url: url_data,
            dataType: 'html',
