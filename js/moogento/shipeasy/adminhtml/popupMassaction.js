        ...
        onSuccess: function(transport) {
            ...
            if (result.msg) {
                ...
                if (result.msg.success) {
                    var successMessages = result.msg.success;
                ...
                if (result.msg.error) {
                    var errorMessages = result.msg.error;
                    messagesHtml += '<li class="error-msg"><ul>';
                    for(i=0; i< errorMessages.length; i++) {
                        messagesHtml += '<li>' + errorMessages[i] +'</li>'
                    }
                    messagesHtml += '</ul></li>';
                }
