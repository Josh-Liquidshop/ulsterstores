...
{
    public function getSafeImage(Mage_Catalog_Model_Product $product, $attributeName, $imageFile=null)
    {
        try{
            $imgSrc =  Mage::helper('catalog/image')->init($product, $attributeName, $imageFile);
        }
        catch(Exception $e) {
