...
class Moogento_ShipEasy_Adminhtml_Sales_Order_ProcessController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        parent::preDispatch();
        #http://magento-mm.dev/index.php/admin/sales_order_process/orderEmailEditFromGrid/
    ...
    public function orderWeightEditFromGridAction(){
        ...
        $result = $this->getLayout()->createBlock('moogento_shipeasy/adminhtml_sales_order_grid_weight')
            ->setOrder($row)
            ->toHtml();
