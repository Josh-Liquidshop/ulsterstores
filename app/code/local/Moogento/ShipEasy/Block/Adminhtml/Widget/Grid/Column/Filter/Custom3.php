...
class Moogento_ShipEasy_Block_Adminhtml_Widget_Grid_Column_Filter_Custom3
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Select
{
	public function getHtml()
    {
        ...
        $html .= '<input type="text" name="'.$this->_getHtmlName().'[custom_value_3]" id="custom_value_3" value="' . $this->getValue('custom_value_3') .'" />';
        $html .= '<input type="text" name="'.$this->_getHtmlName().'[date_custom_value_3]" id="date_custom_value_3" value="' . $this->getValue('date_custom_value_3') .'" / >';
    ...
    public function getCondition()
    {
		...
		$return['custom_value'] = $this->getValue('custom_value_3');
        $return['date'] = $this->getValue('date_custom_value_3');
