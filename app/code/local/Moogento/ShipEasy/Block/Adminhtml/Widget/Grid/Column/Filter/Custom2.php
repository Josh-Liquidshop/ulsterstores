...
class Moogento_ShipEasy_Block_Adminhtml_Widget_Grid_Column_Filter_Custom2
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Select
{
	public function getHtml()
    {
        ...
        $html .= '<input type="text" name="'.$this->_getHtmlName().'[custom_value_2]" id="custom_value_2" value="' . $this->getValue('custom_value_2') .'" />';
        $html .= '<input type="text" name="'.$this->_getHtmlName().'[date_custom_value_2]" id="date_custom_value_2" value="' . $this->getValue('date_custom_value_2') .'" />';
    ...
    public function getCondition()
    {
		...
		$return['custom_value'] = $this->getValue('custom_value_2');
        $return['date'] = $this->getValue('date_custom_value_2');
