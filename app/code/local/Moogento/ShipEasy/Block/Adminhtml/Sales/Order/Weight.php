...
class Moogento_ShipEasy_Block_Adminhtml_Sales_Order_Weight extends Mage_Adminhtml_Block_Template
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('moogento/shipeasy/sales/order/weight.phtml');
    }
