...
{{if city}}{{var city}},  {{/if}}{{if region}}{{var region_code}}, {{/if}}{{if postcode}} {{var postcode}}{{/if}}<br/>
{{var country}}<br/>
...
{{if street3}}{{var street3}}<br />{{/if}}
{{if street4}}{{var street4}}<br />{{/if}}
{{if city}}{{var city|caps}} {{/if}}{{if region}}({{var region_code}}) {{/if}}{{if postcode}}{{var postcode|caps}} {{/if}}<br />
{{var country}}<br/>
{{if telephone}}T: {{var telephone}}<br />{{/if}}
{{if fax}}F: {{var fax}}<br />{{/if}}
{{if vat_id}}VAT: {{var vat_id}}<br />{{/if}}'),
