...
class Moogento_Core_Model_Order_Rewrite_IWDOrderGrid_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    const XML_PATH_ORDER_GRID_COLUMN_WIDTH = 'iwd_ordermanager/grid_order/columns_width';
    ...
    public function prepareCollection($filter, $collection)
    {
        ...
        $this->collection->addFieldToSelect(
            array(
                'status', 'store_id', 'store_name', 'customer_id', 'increment_id',
                'base_grand_total', 'base_total_paid', 'grand_total', 'total_paid', 'base_currency_code',
                'order_currency_code', 'created_at', 'updated_at', 'shipping_name', 'billing_name', 'profit_amount'
            )
        );
    ...
    protected function addBillingAddressToSelect()
    {
        ...
        $selectedCol = array_intersect($this->selectedColumns, array('billing_address', 'billing_company', 'billing_country_id', 'billing_region', 'billing_city', 'billing_street', 'billing_postcode', 'billing_telephone'));
        if (!empty($selectedCol)) {
            $cols = array(
    ...
    {
        $selectedCol = array_intersect($this->selectedColumns, array('shipping_address', 'shipping_company', 'shipping_country_id', 'shipping_region', 'shipping_city', 'shipping_street', 'shipping_postcode', 'shipping_telephone'));
        if (!empty($selectedCol)) {
            $cols = array(
    ...
    public function getOrderGridColumns($dispatchEvent = true)
    {
        ...
        /*if (Mage::helper('iwd_ordergrid')->isAllowHideOrders()) {
            $rows['iwd_om_status'] = $helper->__('Show/Hide Order On Front');
        }*/

        if ($dispatchEvent) {
            Mage::dispatchEvent('iwd_ordergrid_order_grid_columns_settings', array('object' => $this));
        }
    ...
    public function prepareColumns(Mage_Adminhtml_Block_Widget_Grid $grid, $selectedColumns = null)
    {
        ...
        foreach ($selectedColumns as $column) {
            if (isset($orderColumns[$column])) {
                ...
                $index = isset($col['index']) ? $col['index'] : $i;
                if (isset($col['header_css_class'])) {
                    $col['header_css_class'] = 'iwd_om_' . $index . ' ' . $col['header_css_class'];
                } else {
                    $col['header_css_class'] = 'iwd_om_' . $index;
                }
    ...
    protected function prepareGridColumns()
    {
        ...
        $columns = array(
            ...
            'increment_id' => array(
                ...
                'header_css_class' => $textComplexFilter
            ),
            'store_id' => array(
            ...
            'billing_name' => array(
                ...
                'filter_condition_callback' => array($this, 'complexFilter'),
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_GoToCustomer(),
                'header_css_class' => $textComplexFilter
            ),
            'shipping_name' => array(
            ...
            'ordered_products' => array(
                ...
                'filter_condition_callback' => array($this, 'complexFilter'),
                'header_css_class' => $textComplexFilter,
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Items(),
            ),
            'product_sku' => array(
                ...
                'filter_condition_callback' => array($this, 'complexFilter'),
                'header_css_class' => $textComplexFilter,
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Sku(),
            ),
            ...
            'product_images' => array(
                ...
                'sortable' => false,
                'type' => 'text',
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Images(),
            ),
            ...
            'qty' => array(
                ...
                'filter' => false,
                'sortable' => false,
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Quantity()
            ),
            'tax_amount' => array(
            ...
            'creditmemo' => array(
                ...
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Creditmemo(),
                'filter_condition_callback' => array($this, 'complexFilter'),
                'header_css_class' => $textComplexFilter
            ),
            'invoice' => array(
                ...
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Invoice(),
                'filter_condition_callback' => array($this, 'complexFilter'),
                'header_css_class' => $textComplexFilter
            ),
            'shipment' => array(
                ...
                'filter_condition_callback' => array($this, 'complexFilter'),
                'header_css_class' => $textComplexFilter,
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Shipment()
            ),
            ...
            'track_number' => array(
                ...
                'filter_condition_callback' => array($this, 'complexFilter'),
                'header_css_class' => $textComplexFilter,
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Tracknumber(),
            ),
            ...
            'payment_method' => array(
                ...
                'header_css_class' => $selectComplexFilter,
                'filter_condition_callback' => array($this, 'complexFilter'),
                'options' => Mage::getModel('iwd_ordergrid/payment_payment')->getPaymentMethods()
            ),
            ...
            'billing_address' => array(
                ...
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Billing(),
            ...
            'shipping_address' => array(
                ...
                'type' => 'text',
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Shipping(),
            ...
            'customer_note' => array(
                ...
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Removetags(),
            ),
            ...
            'order_comment' => array(
                ...
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Lastcomment(),
            ),
            ...
            'order_comment_first' => array(
                ...
                'filter' => false,
                'sortable' => false,
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Firstcomment(),
            ),
        );
        ...
        if (Mage::getSingleton('admin/session')->isAllowed('sales/order/actions/view')) {
            $columns['action'] = array(
                ...
                'index' => 'stores',
                'is_system' => true,
                'renderer' => new IWD_OrderGrid_Block_Adminhtml_Sales_Order_Grid_Renderer_Actions(),
            );
        }
